...
public class Q02 {
	 ...
	 */
		...
		System.out.println("uc tane pozitif tam sayi giriniz");
		...
		int sayi3 = scan.nextInt();
			...
			if (sayi1 + sayi2 > sayi3 && sayi1 - sayi2 < sayi3&& sayi1 + sayi3 > sayi2
					&& sayi1 - sayi3 < sayi2&& sayi3 + sayi2 > sayi1&&sayi3 - sayi2 < sayi1) {
